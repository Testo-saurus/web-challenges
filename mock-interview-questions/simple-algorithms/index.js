...
function averageWordLength(words) {
  ...
  return numberOfCharacters / words.length;
}
...
console.log(doesWordExist(wordsFind, "madtter"));
...
console.log(howManyTimes(wordsCount, "macine"));
...
console.log("sum is:", sum(mixedArray));
