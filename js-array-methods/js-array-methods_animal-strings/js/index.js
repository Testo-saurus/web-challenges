...
console.log(
  `catStartingFromIndexFiveExists: ${catStartingFromIndexFiveExists}`
);

// Hint: Besides the array method, check out the string method `startsWith()`.
const firstAnimalStartingWithLetterP = animalStrings.filter((animal) => {
  return animal.startsWith("p");
});

console.log(
  `firstAnimalStartingWithLetterP: ${firstAnimalStartingWithLetterP}`
);
...
const animalsSortedAlphabetically = [...animalStrings].sort(); // --> creates a shallow copy
...
console.log(
  `Every animal has more than two letters: ${everyAnimalHasMoreThanTwoLetters}`
);
