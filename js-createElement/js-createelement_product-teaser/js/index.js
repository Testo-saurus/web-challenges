...
newProduct.innerHTML = ` <section class="product__body">
      ...
      <footer class="product__footer">
        ...
        <button type="button" id="buy-button" class="product__buy-button">Buy</button>
      </footer>`;
...
document.getElementById("buy-button").addEventListener("click", () => {
  console.log(
    `some mofo bought that fucking expensive ${name} for ${price}. Unbelievable. People are stupid! `
  );
});
